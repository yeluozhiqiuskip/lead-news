...
public class ApArticleServiceImpl extends ServiceImpl<ApArticleMapper, ApArticle>  implements ApArticleService {
     ...
     * list all articles
     * @param dto
     * @param type 1 load more   2 load new
     * @return
     */
    @Override
...
//        }
        ...
        //2.判断是否存在id
        if(dto.getId() == null){
            //2.1 the id does not exist ==> save the article save article config and save article content
            ...
            //2.2 there exists id, update article, article content
